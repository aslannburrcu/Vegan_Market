...
namespace Vegan_Market.Controllers
{
    public class SubcategoryController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "sub_id,sub_name,cate_no1")] Sub_Category sub_Category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "sub_id,sub_name,cate_no1")] Sub_Category sub_Category)
        {
            if (ModelState.IsValid)
            {
